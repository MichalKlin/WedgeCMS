					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							...
							if (strlen($row_art['contentModArticle'])>0){
								?><a href="<?=$site_action?>?a=<?=$row_art[idModArticle]?>&p=<?=$PAGE?>">czytaj więcej...</a><?
							}
							?>
							<!--
							&nbsp;
...
<script language="javascript">
	function print_article_gr(title,content){
		...
		?>
		<tr>
			<td class="do_druku" colspan="2">
				<a href="javascript:print_article_gr('<?=$title?>','')"><img src="images/print.gif" style="border: 0;" /></a>
			</td>
		</tr>
		<?}?>
		</table>
