<?
$tabela_odw_page = "mod_odwiedziny_page";

$wartosci = "0,\"$PAGE_NAME.html\",\"".date('Y')."\",\"".date('m')."\",\"".date('d')."\",\"".date('H')."\",\"".date('i')."\"";
$result = $this->baza->insert($tabela_odw_page,$wartosci,"","");
...
echo "<span class='licznik'>".$licznik."</span><br /><br />";
$tabela_odw = "mod_odwiedziny";
$czas_licznika = 5*60;
