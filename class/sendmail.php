...
@example
        ...
        $m->From( "admin@surfdeweloper.pl" );
        $m->To( "destination@surfdeweloper.pl" );
        $m->Subject( "E-mail ze strony moeszkanko.info/prm/" );
        ...
        $m->Bcc( "wiadomo");
        $m->Priority(4) ;        
        $m->Attach( "œciezka", "typ pliku" ) ;        

        //alternatywnie mo¿na wys³aæ formularz ze strony
       

        $m->Send();        // send e-mail
        echo "ta wiadmoœæ nie moze byæ wyslana:<br><pre>", $m->Get(), "</pre>";
